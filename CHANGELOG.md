...
### Bug Fixes
- fix(ci): changelog classified commits by whole message, not subject (1fc1a55)

### Chores
- chore(deps): bump anyio in the uv group across 1 directory (854b8e9)
...
### Chores
- chore(ci): bump actions/checkout from 6 to 7 (aee921a)
- chore(deps): bump pydantic-settings in the uv group across 1 directory (fddca17)
